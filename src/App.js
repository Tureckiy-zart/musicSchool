...
export default class App extends Component {
  state = {
    ...
    //     director: "",
    //     id: "1",
    //     // img: "../public/img/teachers/1/1-Самодай.png",
    //     img: "/src/img/teachers/1/1-Книшенко.png",
    //     info:
    //       "Завідуваdate_01чка фортепіанного відділу, викладач класу фортепіано, концертмейстер",
  ...
  render() {
    const { info, departments, isLoading } = this.state;
    const { piano, orcestra, nature, studyWays, collect } = departments;
    return (
      <>
        ...
        <div className="container">
          ...
          {/* <Info data={info} /> */}
          {/* {piano && (
            <Teachers piano={piano} orcestra={orcestra} nature={nature} />
          )} */}
          {/* {studyWays && (
            <StudyWays data={studyWays} title="НАПРЯМКИ НАВЧАННЯ" />
          )} */}
          <GroupMusic data={collect} title="КОЛЕКТИВНЕ МУЗИКУВАННЯ" />
          {/* <SendDocs
